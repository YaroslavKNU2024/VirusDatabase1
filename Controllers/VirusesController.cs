...
namespace VirusDatabaseNew.Controllers
{
    public class VirusesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, string name)
        {
            ...
            //var virusBaseContext = _context.Viruses.Include(v => v.Group);
        ...
        public IActionResult Create(int? groupId) {
            ...
            else
            {
                ...
                ViewBag.GroupName = _context.VirusGroups.Where(g => g.Id == groupId).FirstOrDefault().GroupName;
            }
            return View();
        }
        ...
        public async Task<IActionResult> Create(int groupId, [Bind("Id,VirusName,VirusDateDiscovered,GroupId")] Virus virus)
        {
            ...
            //ViewData["roupId"] = new SelectList(_context.VirusGroups, "Id", "roupName", Virus.roupId);
            //return View(Virus);
            return RedirectToAction("Index", "Viruses", new { id = groupId, name = _context.VirusGroups.Where(c => c.Id == groupId).FirstOrDefault().GroupName });
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VirusName,VirusDateDiscovered,GroupId")] Virus virus)
        {
            if (id != virus.Id)
                return NotFound();
            ...
            ViewData["GroupId"] = new SelectList(_context.VirusGroups, "Id", "Id", virus.GroupId);
            return View(virus);
        }
