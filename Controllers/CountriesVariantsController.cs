...
namespace VirusDatabaseNew.Controllers
{
    public class CountriesVariantsController : Controller
    {
        ...
        public CountriesVariantsController(VirusBaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CountryId,VariantId,Cases,Dead")] CountriesVariant countriesVariant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CountryId,VariantId,Cases,Dead")] CountriesVariant countriesVariant)
        {
